        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 w-full">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={cn('text-center order-2 lg:order-1', dir === 'rtl' ? 'lg:text-right' : 'lg:text-left')}>
              ...
              <p className="text-lg text-surface-500 mb-6 leading-relaxed max-w-lg mx-auto lg:mx-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                {t('landing.hero_desc')}
              </p>

              {/* Social media icons */}
              <div className={cn('flex items-center gap-3 mb-8 animate-fade-in-up', dir === 'rtl' ? 'justify-center lg:justify-start' : 'justify-center lg:justify-start')} style={{ animationDelay: '0.25s' }}>
                {[
                  {
                    label: 'WhatsApp',
                  ...
                  <a
                    ...
                    aria-label={s.label}
                    className={cn(
                      'w-9 h-9 rounded-xl flex items-center justify-center bg-surface-100 text-surface-500 transition-all duration-200 hover:text-white hover:scale-110 hover:shadow-lg',
                      s.color
                    )}
                  >
                    {s.svg}
